...
pub static KOTLIN_CFG: CfgRules = CfgRules {
    ...
    while_node: Some("while_statement"),
    while_nodes: &[],
    do_node: Some("do_while_statement"),
    infinite_loop_node: None,
    unless_node: None,
    until_node: None,
    switch_node: Some("when_expression"),
    switch_nodes: &[],
    case_node: Some("when_entry"),
    case_nodes: &[],
    default_node: None,
    wildcard_pattern_node: None,
    try_node: Some("try_expression"),
    try_nodes: &[],
    catch_node: Some("catch_block"),
    finally_node: Some("finally_block"),
    else_node: None,
    return_node: Some("jump_expression"),
    throw_node: Some("throw_expression"),
    break_node: Some("jump_expression"),
    continue_node: Some("jump_expression"),
    block_node: None,
...
pub static SWIFT_CFG: CfgRules = CfgRules {
    ...
    else_via_alternative: true,
    if_consequent_field: None,
    for_nodes: &["for_in_statement"],
    condition_field: Some("condition"),
    while_node: Some("while_statement"),
    while_nodes: &[],
    do_node: Some("repeat_while_statement"),
    infinite_loop_node: None,
    unless_node: None,
    until_node: None,
    switch_node: Some("switch_statement"),
    switch_nodes: &[],
    case_node: Some("switch_entry"),
    case_nodes: &[],
    default_node: None,
    wildcard_pattern_node: Some("wildcard_pattern"),
    try_node: Some("do_statement"),
    try_nodes: &[],
    catch_node: Some("catch_clause"),
    finally_node: None,
    else_node: None,
...
pub static SCALA_CFG: CfgRules = CfgRules {
    ...
    case_nodes: &[],
    default_node: None,
    wildcard_pattern_node: Some("wildcard"),
    try_node: Some("try_expression"),
    try_nodes: &[],
    catch_node: Some("catch_clause"),
    finally_node: Some("finally_clause"),
...
pub static BASH_CFG: CfgRules = CfgRules {
    ...
    else_via_alternative: false,
    if_consequent_field: None,
    for_nodes: &["for_statement", "c_style_for_statement"],
    condition_field: Some("condition"),
    while_node: Some("while_statement"),
    while_nodes: &[],
    do_node: None,
    infinite_loop_node: None,
    unless_node: None,
    until_node: Some("until_statement"),
    switch_node: Some("case_statement"),
    switch_nodes: &[],
    case_node: Some("case_item"),
    case_nodes: &[],
    default_node: None,
    wildcard_pattern_node: None,
    try_node: None,
...
pub fn get_cfg_rules(lang_id: &str) -> Option<&'static CfgRules> {
    match lang_id {
        ...
        "c" => Some(&C_CFG),
        "cpp" => Some(&CPP_CFG),
        "kotlin" => Some(&KOTLIN_CFG),
        "swift" => Some(&SWIFT_CFG),
        "scala" => Some(&SCALA_CFG),
        "bash" => Some(&BASH_CFG),
        _ => None,
    }
}
