...
for (const round of [1, 2, 3, 4]) {
  ...
  p1.then(
    (a) => {
      // if not a function, the identity function is used
      console.log('then3');
      a();
      ...
      return () => {
        // returned value becomes fulfilled value of result promise
  ...
  p1.then(
    (a) => {
      // one promise can have multiple handlers
